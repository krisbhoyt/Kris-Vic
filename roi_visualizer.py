...
def calculate_roi_with_growth(current_invoice_volume, growth_rate, years, ap_processor_salary, num_ap_processors, 
    ...
    # Calculate automated and non-automated invoice volumes based on the automation rate
    ...
    # Convert to a whole number (no decimals)
    automated_invoice_volume = int(automated_invoice_volume)
                                  
    # Total time spent for non-automated invoices
    non_automated_invoice_volume = int(annual_invoice_volume * (1 - automation_rate / 100))
    ...
    automated_invoice_volume = round(automated_invoice_volume)
